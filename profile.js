document.addEventListener("DOMContentLoaded", function() {
    ...
    window.saveProfile = function(event) {
        ...
        updateProfileDisplay(name, pronouns, contact, biography, links);
        toggleEditForm();
    };

    // Function to update the profile display
    function updateProfileDisplay(name, pronouns, contact, biography, links) {
    ...
    // Load profile data from localStorage and update the display
    function loadProfileData() {
        var name = localStorage.getItem('profileName') || 'K';
        var pronouns = localStorage.getItem('pronouns') || 'She/Her';
        var contact = localStorage.getItem('contact') || '';
        var biography = localStorage.getItem('biography') || '';
        var links = localStorage.getItem('links') || '';

        updateProfileDisplay(name, pronouns, contact, biography, links);

        // Set form fields with stored values
    ...
    loadProfileData();  // Initial load of profile data
});
